    ...
    public class SDK_UnityController : SDK_BaseController
    {
        ...
        */
        ...
        public override void ProcessUpdate(VRTK_ControllerReference controllerReference, Dictionary<string, object> options)
        {
            ...
            {
                uint currentIndex = VRTK_ControllerReference.GetRealIndex(controllerReference);
                GameObject currentController = GetControllerByIndex(currentIndex, true);
                if (currentController != null)
                {
                    previousControllerRotations[currentIndex] = currentControllerRotations[currentIndex];
                    currentControllerRotations[currentIndex] = currentController.transform.rotation;
                    previousControllerPositions[currentIndex] = currentControllerPositions[currentIndex];
                    currentControllerPositions[currentIndex] = currentController.transform.position;
                }
            }
        }
        ...
        public override Vector3 GetVelocity(VRTK_ControllerReference controllerReference)
        {
            ...
            {
                uint currentIndex = VRTK_ControllerReference.GetRealIndex(controllerReference);
                return ((currentControllerPositions[currentIndex] - previousControllerPositions[currentIndex]) / Time.deltaTime);
            }
            return Vector3.zero;
        }
        ...
        public override Vector3 GetAngularVelocity(VRTK_ControllerReference controllerReference)
        {
            ...
            {
                uint currentIndex = VRTK_ControllerReference.GetRealIndex(controllerReference);
                Quaternion deltaRotation = currentControllerRotations[currentIndex] * Quaternion.Inverse(previousControllerRotations[currentIndex]);
